...
local OrionLib = {
        ...
        Themes = {
        Default = {
                Main = Color3.fromRGB(255, 33, 33),      -- Darker reddish
                ...
                Text = Color3.fromRGB(245, 150, 150),        -- Keep text light for contrast
                TextDark = Color3.fromRGB(190, 75, 75)     -- Adjusted to valid RGB range
            }
    },
